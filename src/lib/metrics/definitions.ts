...
export const METRIC_DEFINITIONS: Record<string, MetricDefinition> = {
  net_premiums_earned: {
    ...
    unit: "currency",
    category: "premiums",
    applicable_sectors: ["P&C", "Life", "Reinsurance", "Mortgage Insurance"],
  ...
  losses_incurred: {
    ...
    applicable_sectors: ["P&C", "Reinsurance", "Mortgage Insurance"],
  ...
  expense_ratio: {
    ...
    label: "Expense Ratio",
    description:
      "(Acquisition costs + underwriting expenses) / net premiums earned. Lower means more efficient operations.",
    unit: "percent",
    category: "underwriting",
    applicable_sectors: ["P&C", "Reinsurance", "Mortgage Insurance"],
    higher_is_better: false,
  ...
  net_income: {
    ...
    applicable_sectors: ["P&C", "Life", "Health", "Reinsurance", "Brokers", "Title", "Mortgage Insurance"],
    higher_is_better: true,
    format_decimals: 0,
  },
  roe: {
  ...
  revenue: {
    ...
    unit: "currency",
    category: "profitability",
    applicable_sectors: ["Health", "Brokers", "Title"],
    higher_is_better: true,
    format_decimals: 0,
  },
  total_debt: {
  ...
  medical_loss_ratio: {
    ...
    description:
      "Medical claims expense divided by premium revenue. ACA requires minimum 80-85% MLR. Lower MLR = wider admin margin (insurer operations view).",
    unit: "percent",
    category: "health",
